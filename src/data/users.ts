...
export const LOCAL_USERS: LocalUser[] = [
  ...
  { username: 'fabri', password: 'fabri123', full_name: "Fabri", avatar_url: '/avatars/fabri.png', role: 'user' },
  ...
  { username: 'juanjo', password: 'juanjo123', full_name: "Juanjo", avatar_url: '/avatars/juanjo.png', role: 'user' },
